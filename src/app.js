...
typeorm_1.createConnection({ type: "mysql", host: "localhost", port: 3306, username: "root", password: "ganko123", database: "yt_node_admin", entities: [product_1.Product], synchronize: true, logging: false }).then(function (db) {
    var productRepository = db.getRepository(product_1.Product);
    amqp.connect('amqps://mzerdkfy:XL2VSalO9-BGsN5FnzJgsfDO_7qVigo5@hornet.rmq.cloudamqp.com/mzerdkfy', function (error0, connection) {
        if (error0) {
            throw error0;
        }
